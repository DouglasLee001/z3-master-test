...
//        if(mt()%100<99){
            ...
            bool time_up_bool=(no_improve_cnt_bool*_lit_in_unsast_clause_num>2*_bool_lit_in_unsat_clause_num);
            bool time_up_idl=(no_improve_cnt_idl*_lit_in_unsast_clause_num>10*(_lit_in_unsast_clause_num-_bool_lit_in_unsat_clause_num));
            ...
            if((!is_in_bool_search&&_bool_lit_in_unsat_clause_num>0&&time_up_idl)||(_lit_in_unsast_clause_num==_bool_lit_in_unsat_clause_num)){enter_bool_mode();}
